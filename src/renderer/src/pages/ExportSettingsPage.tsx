...
export function ExportSettingsPage() {
  ...
  return (
    <div className="flex gap-6 h-full overflow-hidden">
      ...
      <div className="flex flex-col gap-5 flex-1 overflow-y-auto min-w-0">
      ...
      <div className="flex flex-col gap-5 w-64 shrink-0 overflow-y-auto">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <div className="flex flex-col gap-0.5">
              <span className="text-zinc-500 text-xs">Audio parts</span>
              <span className="text-zinc-300">{audioFiles.length} file{audioFiles.length !== 1 ? 's' : ''}</span>
            </div>
            <div className="flex flex-col gap-0.5">
              <span className="text-zinc-500 text-xs">Total duration</span>
              <span className="text-zinc-300">{formatDuration(totalDuration)}</span>
            </div>
            <div className="flex flex-col gap-0.5">
              <span className="text-zinc-500 text-xs">Subtitles</span>
              <span className="text-zinc-300">
                {srtPath
                  ? basename(srtPath)
                  : subtitleSource === 'ai'
                    ? <span className="text-violet-400">AI on convert</span>
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-zinc-500 text-xs">Format</span>
